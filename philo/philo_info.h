...
{
    t_philo         *philo;
    int             total_num;      // 철학자 수, av[1]
    int             survival_time;  // time to die, av[2]
    int             eating_time;    // time to eat, av[3]
    int             sleep_time;     // time to sleep, av[4]
    int             eating_num;     // 식사 횟수, av[5]
    int             init_point;     // 프로그램 시작 시간
